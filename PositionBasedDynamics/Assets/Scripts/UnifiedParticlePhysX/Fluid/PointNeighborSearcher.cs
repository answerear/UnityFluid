...
namespace UnifiedParticlePhysX
{
    ...
    public abstract class PointNeighborSearcher
    {
        ...
        /// <param name="callbcack">查找到回调，回调第一个参数是找到相邻粒子在相邻粒子集合索引，第二个参数是找到的相邻粒子在整个particles集合中的索引</param>
        public abstract void ForeachNearbyPoint(int origin, float radius, Callback<int, int> callbcack);
    }
}
